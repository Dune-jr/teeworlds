...
image_editoricons = Image("editoricons", "editor/icons.png", 1)
...
container.images.Add(image_editoricons)
...
set_editoricons = SpriteSet("editoricons", image_editoricons, 4, 1)
...
container.spritesets.Add(set_editoricons)
