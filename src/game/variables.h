...
MACRO_CONFIG_STR(SvGametype, sv_gametype, 32, "race", CFGFLAG_SAVE|CFGFLAG_SERVER, "Game type (dm, tdm, ctf, lms, lts)")
...
//MACRO_CONFIG_INT(SvSpectatorSlots, sv_spectator_slots, 0, 0, MAX_SPECTATORS, CFGFLAG_SAVE|CFGFLAG_SERVER, "Number of slots to reserve for spectators")
...
MACRO_CONFIG_INT(SvInactiveKickTime, sv_inactivekick_time, 0, 0, 1000, CFGFLAG_SAVE|CFGFLAG_SERVER, "How many minutes to wait before taking care of inactive clients")
...
MACRO_CONFIG_INT(SvInfiniteAmmo, sv_infinite_ammo, 1, 0, 1, CFGFLAG_MAPSETTINGS|CFGFLAG_SERVER, "Enable or disable infinite ammo")
